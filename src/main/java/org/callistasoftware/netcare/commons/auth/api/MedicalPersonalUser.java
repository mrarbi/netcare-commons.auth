 ...
 *
 */
public interface MedicalPersonalUser extends HosUserInterface {

    CareUnitInterface getCareUnit(String careUnitId);

    Set<CareUnitInterface> getCareUnits();
    
    void addCareUnit(final CareUnitInterface careUnit);
